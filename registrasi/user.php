...
function regisadmin($data) {
  ...
  if( $password !== $password2) {
    ...
    <div class='toast-body'>
    <p><b class='text-danger'>Gagal Membuat Akun!</b> Password dan konfirmasi password anda tidak sesuai, silahkan cek dan ulang kembali.</p>
  ...
  <div class="container" style="margin-top: 5rem;">
    ...
    <div class="col-xl-4 col-md-4 col-md-4">
        ...
        <div class="card">
          ...
          <button class="w-100 btn btn-primary btn-sm mt-3" name="register" type="submit">Buat Akun</button>
