       ...
       $data = mysqli_fetch_assoc($result);
        ...
        <div class="row text-center">
          <div class="col-md mt-3" style="font-weight: 10;">
            <p>CashApp merupakan sebuah aplikasi cash bulanan berbasis web sederhana, dan di dalamnya terdapat dua hak akses yaitu admin dan user yang pertama admin sebagaimana admin ini adalah pengurus atau pengelola dana masuk maupun keluarnya dana dan juga dapat mengelola berbagai macam data di dalamnya, dan User ia hanya dapat melihat detail perkembangan masuk dan keluarnya dana terbaru/terupdate.
            </p>

            <p>Tidak hanya itu aplikasi ini juga dilengkapi dengan fitur diskusi dimana seorang admin maupun user (All Registered) dapat saling berkomunikasi secara langsung/chatting saling berkomentar, mengajukan, pernyataan dan memberi pendapat.</p>

            <p>Aplikasi ini katanya mempunyai 2 hak akses admin dan user, lalu dimana hak akses usernya? sebenarnya untuk hak akses user sudah saya buat dan mohon maaf untuk hak akses user belum saya upload, karena aplikasi ini belum memiliki fasilitas login multi user, untuk fitur dari user sudah di jelaskan di atas dan kedepanya aplikasi ini akan terapkan sistem login multi user dan fitur fitur yang unik.
            </p>

            <p>Jika anda berminat dengan aplikasi ini boleh Anda gunakan sebagai refrensi belajar atau Anda ingin gunakan untuk keperluan Anda. Untuk source code Anda bisa unduh dari github link unduh ada di bawah dan untuk selengkapnya boleh tanya tanya <a href="https://wa.me/+6285813100467"><b>Disini</b>.</a></p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md text-center mt-5">
              ...
              <a href=""><h5 style="font-weight: 300;">Unduh dari github <i class="fas fa-external-link-alt"></i></h5></a>
            </div>
          </div>
        </div>
      </div>
