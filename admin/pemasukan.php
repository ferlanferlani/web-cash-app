...
<head>
    ...
    <title>CashApp - Kelola Dana Masuk</title>
                                                    ...
                                                    <div class="col">
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="number" name="pemasukan" class="form-control" placeholder="Nominal" required value="<?= $pemasukan["pemasukan"]; ?>" >
                                                            ...
                                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                                <input type="text" name="waktu" class="form-control datetimepicker-input" data-target="#reservationdate" value="<?= $pemasukan["waktu"]; ?>" />
                                                            ...
                                                            <div class="form-group mt-2">
                                                                ...
                                                                <input class="form-control" rows="10" name="keterangan" id="keterangan" required placeholder="Tulis Keterangan..." autocomplete="off" value="<?= $pemasukan["keterangan"]; ?>"></input>
                                                            </div>
