...
$id = $_GET["id"];
$agustus = query("SELECT * FROM agustus WHERE id = $id")[0];
...
// cek cek
  if( ubah8($_POST) > 0) {
   ...
   <a href='agustus' class='btn btn-outline-primary btn-sm'>Kembali</a>
   </div>
   </div>     
   </div>";
} else {
    ...
    <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
              <a href="agustus">  <button class="btn shadow-sm btn-sm btn-info mb-3">Kembali</button></a>
                      ...
                      <div class="row mt-3">
                        <div class="col">
                            <form action="" method="post">
                                <input type="hidden" name="id" value="<?= $agustus["id"]; ?>">

                                <div class="input-group mb-3">
                                   <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                </div>
                                <input type="text" name="nama" class="form-control" placeholder="Nama" value="<?= $agustus["nama"]; ?>">
                            </div>
                            ...
                            <div class="input-group mb-3">
                             ...
                             <input type="number" name="tunai" class="form-control" placeholder="Nominal" required value="<?= $agustus["tunai"]; ?>" >
