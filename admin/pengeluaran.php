...
<head>
    ...
    <title>CashApp - Kelola Dana Keluar</title>
                                    ...
                                    <div class="col">
                                        <form action="" method="post">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="pengeluaran" class="form-control" placeholder="Nominal" required value="<?= $pengeluaran["pengeluaran"]; ?>" >
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input type="text" name="waktu" class="form-control datetimepicker-input" data-target="#reservationdate" value="<?= $pengeluaran["waktu"]; ?>" />
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <input class="form-control" rows="10" name="keterangan" id="keterangan" required placeholder="Tulis Keterangan..." autocomplete="off" value="<?= $pengeluaran["keterangan"]; ?>"></input>
                                            </div>
