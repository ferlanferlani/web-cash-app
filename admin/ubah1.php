...
$id = $_GET["id"];
$januari = query("SELECT * FROM januari WHERE id = $id")[0];
    ...
    <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- diskusi -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link " href="akamsi-forum-disquse" target="_blank" role="button">
            ...
            <div class="container-fluid">
              <a href="januari">  <button class="btn shadow-sm btn-sm btn-info mb-3">Kembali</button></a>
...
// cek cek
              if( ubah1($_POST) > 0) {
                 ...
                 <p><span class='text-success'>Berhasil diubah!</span> Data berhasil diubah.</p>
                 <a href='januari' class='btn btn-outline-primary btn-sm'>Kembali</a>
                 </div>
                 </div>     
                 </div>";
             } else {
                ...
                <div class='toast-body'>
                <p><span class='text-danger'>Gagal di diubah!</span> Data gagal di diubah. Sistem mengalami error langsung laporkan pada developer guna langsung menangani masalah ini.</p>
                  ...
                  <div class="row mt-3">
                    <div class="col">
                        <form action="" method="post">
                            <input type="hidden" name="id" value="<?= $januari["id"]; ?>">

                            <div class="input-group mb-3">
                               <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                            </div>
                            <input type="text" name="nama" class="form-control" placeholder="Nama" value="<?= $januari["nama"]; ?>">
                        </div>
                        ...
                        <div class="input-group mb-3">
                         ...
                         <input type="number" name="tunai" class="form-control" placeholder="Nominal" required value="<?= $januari["tunai"]; ?>" >
                         <div class="input-group-append">
                             <span class="input-group-text">,00.</span>
                         </div>
                     </div>
                     <button type="submit" name="submit" class="btn btn-sm btn-primary mb-3">Simpan</button>
                 </form>
             </div>
         </div>
     </div>
