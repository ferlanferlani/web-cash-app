...
<head>
    ...
    <title>CashApp - Tambah Cash</title>
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <!-- Nav Item - Tables -->
                        <li class="nav-item">
                            <a class="nav-link" href="akamsi-aktif">
                            ...
                            <div class="container">
                                ...
                                if(isset ($_POST["submit"] )) {
                                    ...
                                    if(tambah12($_POST) > 0 ){
                                        ...
                                        <p><span class='text-success'>Berhasil di ditambahkan!</span> $nama dengan nominal pembayaran Rp$nominal,00. berhasil di ditambahkan.</p>
                                        ...
                                        <div class='toast-body'>
                                        <p><span class='text-danger'>Gagal di ditambahkan!</span> $nama gagal di ditambahkan. Sistem mengalami error langsung laporkan pada developer guna langsung menangani masalah ini.</p>
                                                    ...
                                                    <div class="col">
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="number" name="tunai" class="form-control" placeholder="Nominal" required>
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">,00.</span>
                                                                </div>
                                                            </div>
                                                            <button type="submit" name="submit" id="tombol" class="btn btn-sm btn-primary mb-3">Selesai</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
