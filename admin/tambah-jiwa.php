...
<head>
    ...
    <title>CashApp - Tambah Jiwa</title>
            ...
            <div class="container">
                ...
                if( isset($_POST["submit"] )) {
                    ...
                    if( tambahakamsi($_POST) > 0 ) {
                        ...
                        <p><span class='text-success'>Berhasil ditambahkan!</span> $nama berhasil ditambahkan.</p>
                        <a href='jiwa' class='btn btn-outline-primary btn-sm'>Kembali</a>
                        </div>
                        </div>     
                        </div>";
                    } else {
                        ...
                        <div class="container">
                          <div class="row mt-3">
                            <div class="col">
                                ...
                                <button type="submit" name="submit" class="btn btn-sm btn-primary mb-3">Tambah Data</button>
                            </form>
                        </div>
                    </div>
                </div>
