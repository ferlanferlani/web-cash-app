...
$id = $_GET["id"];
$februari = query("SELECT * FROM februari WHERE id = $id")[0];
...
// cek cek
  if( ubah2($_POST) > 0) {
   ...
   <a href='februari' class='btn btn-outline-primary btn-sm'>Kembali</a>
   </div>
   </div>     
   </div>";
} else {
    ...
    <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
              <a href="februari">  <button class="btn shadow-sm btn-sm btn-info mb-3">Kembali</button></a>
                      ...
                      <div class="row mt-3">
                        <div class="col">
                            <form action="" method="post">
                                <input type="hidden" name="id" value="<?= $februari["id"]; ?>">

                                <div class="input-group mb-3">
                                   <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                </div>
                                <input type="text" name="nama" class="form-control" placeholder="Nama" value="<?= $februari["nama"]; ?>">
                            </div>
                            ...
                            <div class="input-group mb-3">
                             ...
                             <input type="number" name="tunai" class="form-control" placeholder="Nominal" required value="<?= $februari["tunai"]; ?>" >
