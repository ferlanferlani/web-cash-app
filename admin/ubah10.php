...
$id = $_GET["id"];
$oktober = query("SELECT * FROM oktober WHERE id = $id")[0];
...
// cek cek
  if( ubah10($_POST) > 0) {
     ...
     <a href='oktober' class='btn btn-outline-primary btn-sm'>Kembali</a>
     </div>
     </div>     
     </div>";
 } else {
...
<li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="jiwa">
            ...
            <span>Pemuda & Remaja Akamsi</span></a>
        </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
              <a href="oktober">  <button class="btn shadow-sm btn-sm btn-info mb-3">Kembali</button></a>
                      ...
                      <div class="row mt-3">
                        <div class="col">
                            <form action="" method="post">
                                <input type="hidden" name="id" value="<?= $oktober["id"]; ?>">

                                <div class="input-group mb-3">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                </div>
                                <input type="text" name="nama" class="form-control" placeholder="Nama" value="<?= $oktober["nama"]; ?>">
                            </div>
                           ...
                           <input type="number" name="tunai" class="form-control" placeholder="Nominal" required value="<?= $oktober["tunai"]; ?>" >
