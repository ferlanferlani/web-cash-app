...
// cek cek
  if( ubahdataakamsi($_POST) > 0) {
   ...
   <a href='pemuda-&-remaja-akamsi' class='btn btn-outline-primary btn-sm'>Kembali</a>
   </div>
   </div>     
   </div>";
} else {
...
<head>
    ...
    <title>CashApp - Ubah Data jiwa</title>
    ...
    <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <a href="jiwa">  <button class="btn btn-sm shadow-sm btn-info mb-3">Kembali</button></a>
            </div>
            <div class="container">
