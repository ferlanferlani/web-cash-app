...
<head>
    ...
    <title>CashApp - Bug Report</title>
                ...
                <div class="col-xl col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">LAPORKAN BUG</h6>
                                    </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <p><b>"</b>Demi kenyamanan bersama<b>"</b> dimohon untuk kerjasamanya jika anda menemukan sebuah <i><b>bug</b></i> atau <i><b>error</b></i> dalam fungsi atau kerja aplikasi ini jangan ragu untuk langsung laporkan dan jangan lupa sertakan screenshot bug tersebut, Klik tombol di bawah  ini guna menghubungi developer untuk memperbaiki kesalahan/bug.</p>
                                    <p>Terimakasih.</p>
                                    <a href="https://wa.me/6285813100467" class="btn btn-danger shadow btn-sm" ><i class="fas fa-bug"></i> Laporkan bug</a>
                                    </div>
                            </div>
                        </div>
                </div>
