...
<head>
    ...
    <title>CashApp - Detail Pengeluaran Dana</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                ...
                <a href="detail-pemasukan.php?id= <?= $row ["id"]; ?>" class="btn btn-primary btn-sm shadow-sm ">Detail Pemasukan</a>
                <?php endforeach; ?>
                <a href="#" class="btn btn-primary btn-sm shadow-sm active" aria-current="page">Detail Pengeluaran</a>
            </div>
                    </div>
                </div>
            </div>
                                  ...
                                  <div class="row mt-3">
                                    ...
                                    <form action="" method="post">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" name="pengeluaran" class="form-control" placeholder="Nominal" required value="<?= $pengeluaran["pengeluaran"]; ?>" disabled >
                                                ...
                                                <input type="text" name="waktu" class="form-control datetimepicker-input" data-target="#reservationdate" value="<?= $pengeluaran["waktu"]; ?>" disabled />
