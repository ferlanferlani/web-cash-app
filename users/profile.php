...
<head>
    ...
    <title>CashApp - Profile admin</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <a href=".">  <button class="btn btn-sm shadow-sm btn-info mb-3">Kembali</button></a>
            </div>
            <div class="container">
                      ...
                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between text-center">   
                        ...
                        ?>
                                ...
                                <div class="container">
                                    ...
                                    if( isset($_POST["ubah"]) ) {
                                        ...
                                        if( ubahprofileadmin($_POST) > 0) {
                                            echo"<div class='alert alert-success alert-dismissible fade show mt-3' role='alert'>
                                                    Berhasil diubah! <a href='my-profile' class='alert-link';>Refresh</a>
                                                 </div>";
                                            
                                        }else {
                                            echo"<div class='alert alert-danger alert-dismissible fade show mt-3' role='alert'>
                                                    Gagal diubah! <a href='bug' class='alert-link';>Laporkan!</a>
                                                 </div>";
                                        }
                                    ...
                                    <!-- <div class="row mt-3">
                                        <div class="col-md">
                                            <p style="font-weight: 20;" >Disini anda dapat mengbah atau mengedit akun anda mulai dari nama lengkap, alamat email, password, dan bahkan anda bisa menambahkan nama gaul/nama panggilan dan ini opsional.</p>
                                        </div>
                                    </div> -->
                                   ...
                                   <div class="row justify-content-center mt-3">
                                        <div class="col-md text-center">
                                            <i class="fas fa-user-circle text-gray-400" style="font-size: 120px;"></i>
                                        </div>
                                    </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="card shadow mb-4">
                     <!-- Card Header - Dropdown -->
                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between text-center">   
                         <h6 class="m-0 font-weight-bold text-primary">Hapus Akun Saya</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="container">
                         <div class="row mt-3">
                          <div class="col-md">
                            <p style="font-weight: 20;">Semua data yang anda gunakan di dalam aplikasi ini akan di hapus secara permanen dan tidak dapat di aktifkan kembali.</p>
                          </div>
                        </div><a href="hapus-admin.php?id= <?= $data["id"]; ?>" onclick="return confirm('KONFIRMASI! Tindakan ini akan menghapus akun anda secara permanen klik Ok jika setuju');" class="btn btn-danger btn-sm my-3">Hapus Akun</a>
                       </div>
                      </div>
                    </div>
                 </div>
